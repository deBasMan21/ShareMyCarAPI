...
namespace EndpointTests.CarTests
{
    public class DeleteCar
    {
        ...
        public void Delete_Should_Return_Car()
        {
            ...
            carRepo.Setup(c => c.Delete(It.IsAny<Car>(), user1)).Returns(car);
            ...
            // ACT
            var response = sut.Delete(car.Id);
        ...
        public void Delete_Should_Return_Unauthorized()
        {
            ...
            Car car = new Car() { Id = 1, Name = "test", OwnerId = user1.Id + 1 };
            ...
            Assert.Equal("Not authorized to delete this car", result?.Message);
        }
    }
}
